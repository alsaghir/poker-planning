...
import com.github.alsaghir.pokerplanning.presentation.model.LocalViewModelFactory
...
import com.github.alsaghir.pokerplanning.presentation.model.ViewModelFactory
...
fun App(appContainer: AppContainer = remember { AppContainer() }) {
    ...
    // remember avoids recreation of ViewModelFactory on recomposition.
    // It will only be recreated if appContainer changes, which is unlikely in this setup
    val viewModelFactory = remember(appContainer) { ViewModelFactory(appContainer) }

    val themeViewModel: ThemeViewModel = viewModel { viewModelFactory.themeViewModel() }
